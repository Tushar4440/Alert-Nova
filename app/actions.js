...
export async function addProduct(formData) {
    ...
    try {
        ...
        const currency = productData.currentCode || "USD";
        ...
        const isUpdate = !!existingProducts;
        ...
        // Add to price history if its new  product or price changed 
        const shouldAddHistory = !isUpdate || existingProduct.currentPrice !== newPrice;
        if (shouldAddHistory) {
        ...
        return {
            ...
            product,
            message: isUpdate
                ? "Product Update with latest price!"
...
export async function deleteProduct(productId) {
    try {
        const supabase = await createClient(); // getting backend things from supabase 
